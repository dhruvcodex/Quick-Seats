...
public class UserForgot extends HttpServlet {
    ...
    String sub = "Quick Seats : Password Update Request";

    // Proper concatenation of email into the URL
    String msg = "Click on this link to Update Password: http://localhost:8080/Ticket_Booking_System/userupdate.jsp?mail=" + to;
